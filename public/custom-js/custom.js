...
function checkLoginStatus() {
    ...
    if (loggedin==1) {
        ...
        document.querySelector('#loginlogout').innerHTML="<i class=\"fa-solid fa-right-to-bracket fa-flip-horizontal\"></i> Logout";
        ...
        document.querySelector('#loginlogout').innerHTML="<i class=\"fa-solid fa-right-to-bracket\"></i> Login"; 
